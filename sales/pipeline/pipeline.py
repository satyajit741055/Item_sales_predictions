...
from sales.entity.artifcat_entity import DataIngestionArtifact, DataValidationArtifact,DataTransformationArtifact,ModelTrainerArtifact,ModelEvaluationArtifact,ModelPusherArtifact
from collections import namedtuple
from sales.entity.experiment import Experiment
...
class Pipeline(Thread):
    experiment: Experiment = Experiment(*([None] * 11)) #Shortcut to give value to all variables in tuple
