...
from sales.entity.config_entity import DataIngestionConfig,TrainingPipelineConfig,ModelPusherConfig , ModelEvaluationConfig , ModelTrainerConfig,DataTransformationConfig,DataValidationConfig 
...
class Configuration:
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            DATA_TRANSFORMATION_ARTIFACT_DIR,self.current_time_stamp)
            ...
            transformed_train_file = os.path.join(data_transformation_artifact_dir,
                                                        data_transformation_config[DATA_TRANSFORMATION_PREPROCESSING_FILE_DIR],
                                                        data_transformation_config[DATA_TRANSFORMATION_TRAIN_FILE_NAME_KEY])

            transformed_test_file = os.path.join(data_transformation_artifact_dir,
                                                        data_transformation_config[DATA_TRANSFORMATION_PREPROCESSING_FILE_DIR],
